...
```{r data_import}
observations_per_country <-read.csv("C:/Users/simpl/Desktop/Portafolio/UFO_Project/UFO_Sightings_SQL_Export/Observations_Per_Country.csv", header=TRUE, stringsAsFactors=FALSE)

observations_per_hour_of_the_day <-read.csv("C:/Users/simpl/Desktop/Portafolio/UFO_Project/UFO_Sightings_SQL_Export/Observations_Per_Hour_of_the_Day.csv", header=TRUE, stringsAsFactors=FALSE)

observations_per_state <-read.csv("C:/Users/simpl/Desktop/Portafolio/UFO_Project/UFO_Sightings_SQL_Export/Observations_Per_State.csv", header=TRUE, stringsAsFactors=FALSE)

observations_per_year <-read.csv("C:/Users/simpl/Desktop/Portafolio/UFO_Project/UFO_Sightings_SQL_Export/Observations_Per_Year.csv", header=TRUE, stringsAsFactors=FALSE)
