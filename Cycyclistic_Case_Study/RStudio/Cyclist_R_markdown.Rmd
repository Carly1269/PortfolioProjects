...
```{r data_import}
ride_information <-read.csv("C:/Users/simpl/Desktop/Portafolio/Cyclistic_Case_Study/Cyclistic_Data_SQL_Export/ride_information.csv", header=TRUE, stringsAsFactors=FALSE)
```
